...
//                   <li>Customized Educational Plan</li>
...
//                 </h5>
//                 <p className="text-gray-600 mb-4 font-semibold">
//                   Our most extensive package offering in-depth support and
//                   guidance throughout the application and interview process.
//                 </p>
//                 <ul className="list-disc list-inside text-gray-600 mb-4 font-medium">
//                   <li>In-depth Career and Educational Assessment</li>
//                   <li>Customized Long-Term Planning</li>
//                   <li>Unlimited Counseling Sessions</li>
//                   <li>Extensive Mock Interview Preparation</li>
//                   <li>Post-Application Support</li>
//                 </ul>
...
// src/components/CourseDetails3.js
import React from "react";
import { Link } from "react-router-dom";
...
function CourseDetails3() {
  return (
    <>
      ...
      <div className="bg-[#F2F2F2] min-h-screen course-details">
        <header className="bg-gradient-to-r from-[#3498db] to-[#2c3e50] text-white py-16 px-6 md:py-24 md:px-10 text-center font-serif">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-4 font-serif leading-tight">
            Counseling Services
          </h1>
          ...
          <div className="mt-4 mb-4">
            ...
            <div className="mt-6">
              ...
              <div className="bg-gray-100 shadow-lg rounded-lg p-6 mb-6 border border-gray-300 h-full transition-all duration-300 hover:shadow-2xl">
                ...
                <p className="text-gray-600 mb-4 font-semibold">
                  Comprehensive support including detailed career planning and
                  application assistance.
                </p>
                <ul className="list-disc list-inside text-gray-600 mb-4 font-medium">
                  <li>In-Depth Career Assessment</li>
                  <li>Personalized Educational Guidance</li>
                  <li>Application Assistance and Review</li>
                </ul>
